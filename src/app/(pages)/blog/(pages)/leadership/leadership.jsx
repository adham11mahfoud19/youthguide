...
const Leadership = () => {
  return (
    <div className='dark:bg-darkbg'>
     ...
     <div className="pt-">
     <ul className='grid grid-cols-2 md:grid-cols-4 gap-x-6 border-2 border-bluePrime bg-bluePrime rounded-3xl justify-center w-[90%] m-auto'>
            ...
            <Link href={'/blog/ve-and-design'} className='w-[100%] duration-150 hover:bg-white hover:text-bluePrime  py-3 flex justify-center items-center px-4 text-white  font-bold'>
                التصميم والمونتاج
            </Link>
            ...
            <Link href={'/blog/leadership'} className='w-[100%] py-3 flex justify-center bg-white items-center px-4 font-bold text-bluePrime'>
                ريادة الأعمال
            </Link>
        </ul>
     </div>
            ...
            <div className='mt-8 grid grid-cols-2 justify-center items-center gap-x-4 md:gap-x-0 gap-y-8 px-6'>
                ...
                <Link href={"/"} className='mx-auto py-6 px-4 w-[100%] md:w-[60%] lg:w-[40%] h-[100px] flex justify-center items-center text-xl text-center text-white font-bold 
